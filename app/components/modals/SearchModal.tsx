...
const SearchModal = () => {
  ...
  // Re-render map everytime location changes
  const Map = useMemo(
    () =>
      dynamic(() => import("../Map"), {
        ssr: false,
  ...
  const onSubmit = useCallback(async () => {
    ...
    // Convert date to string to put to URL
  ...
  // Render next button according to steps
  ...
  // Render back button according to steps
